	...
	<div class="container">
		...
		<div class="main">
			...
			<div class="paging">
					...
					<c:if test="${page > 5 }">
						<a href="seller_salesList?sub=2&page=${startPage-5 }"> ‹ </a>
						</c:if>
					<c:if test="${page < 6 && page > 1}">
						<a href="seller_salesList?sub=2&page=1"> ‹ </a>
					</c:if>
					<c:forEach begin="${startPage }" end="${endPage }" var="i">
						...
						<c:if test="${page ne i }">
							<a href="seller_salesList?sub=2&page=${i }"><span>${i }</span></a>
						</c:if>
					</c:forEach>
					...
					<c:if test="${startPage+5 > totalPage && page < totalPage}">
						<a href="seller_salesList?sub=2&page=${totalPage }"> › </a>
					</c:if>
				</div>
		</div>
	</div>
