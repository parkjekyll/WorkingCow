...
.charge input[type="text"] {border-radius: 5px; margin: 10px 0; height: 40px; width: 90%;}
			...
			<div class="main_detail">
				<div class="charge">
					<div class="charge_money">
						<h3>충전금액</h3>
						<input type="text" placeholder="금액을 입력해주세요." id="cash">
					</div>
					<div class="charge_amount">
						<div class="charge_Amount_now"><span>보유금액</span></div>
						<div class="charge_Amount_now_view"><span>1,000,000,000 WC</span></div>
					</div>
					
					<div class="charge_afterAmount">
						<div class="charge_Amount_after"><span>충전 후 금액</span></div>
						<div class="charge_Amount_now_view"><span>1,000,000,000,000 WC</span></div>
					</div>
				</div>
				...
				<div class="payment">
					...
					<div class="payment_passbook" >
						...
						<button class ="btn btn-primary" onclick="return deposit()">신청</button>
					</div>
					
					<div class="payment_content" >
						<span>* 결제시 부가세 10%가 포함된 금액으로 결제됩니다. <br><br>
							* 결제 후 사용내역이 없을 경우 결제 월(月) 중 환불이 가능합니다.<br><br>
							* 결제취소는 고객센터 또는 1:1 문의게시판을 통해 처리가 가능합니다.<br><br>
							* 입금 완료 후 결제금액이 지급되기까지는 약 1~10분 정도 소요 될 수 있습니다.<br>
						</span>
					</div>
				</div>
				<div class="chargeMileageList"><a href="myPage_chargeMileageList">마일리지 충전 내역 보기</a></div>
			</div>
		</div>
	</div>
			<!-- footer -->
